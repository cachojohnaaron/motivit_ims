    ...
    <v-row>
        ...
        <div id="tblUser" class="card" >
            <div class="table-responsive-sm">
                ...
                <table id="tblAssetDeployed" class="table-sm table-hover" ref="table" :data="data">
                    <thead class="">
                        <tr>
    ...
    methods: {
        ...
        setAssetsDeployedDebounced: debounce(function(search) {
            ...
            setTimeout(function(){
                ...
                asset.transaction_date.toLowerCase().includes(search.toLowerCase())
                );
			}.bind(this),1000);
        }, 2000),
