  ...
  computed: {
        filteredAccessory() {
            return this.Accessory.filter((acs) => {
                return acs.acs_name.toLowerCase().includes(this.search.toLowerCase()) ||
                  acs.acs_manufacturer.toLowerCase().includes(this.search.toLowerCase()) ||
                  acs.name.toLowerCase().includes(this.search.toLowerCase()) ||
                  acs.transaction_date.toLowerCase().includes(this.search.toLowerCase());
            });
        }
  }
  */
